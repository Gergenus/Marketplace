...
type RepositoryInterface interface {
	...
	GetStockByID(ctx context.Context, product_id, seller_id int) (int, error)         // must have
	AddStockByID(ctx context.Context, seller_id, product_id, number int) (int, error) // must have
	...
	CheckProductExists(ctx context.Context, seller_id int, product_name string) (bool, error)
}
